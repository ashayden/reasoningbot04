    ...
    def analyze(
        ...
        if previous:
            prompt = (
                ...
                "Build progressively deeper understanding from previous analysis.\n"
            ...
            prompt = (
                ...
                "   - Critical aspects and relationships\n"
...
class SynthesisExpert(BaseAgent):
    ...
    def synthesize(self, topic: str, research_results: List[ResearchResult]) -> Optional[str]:
        ...
        prompt = (
            ...
            "   - Open with the central question or topic\n"
            "   - Present key discoveries and insights\n"
            "   - Highlight significant patterns\n"
            "   - Emphasize concrete implications\n\n"
            "3. Key Findings\n"
            ...
            "   - Present forward-looking insights\n"
            "   - End with meaningful implications\n\n"
